...
const { buildReviewPacket, findingFingerprint, mergeReviews, validateReview } = require("../lib/modularity-review");
const modularityRunner = path.resolve(__dirname, "..", "scripts", "harness-modularity.js");
