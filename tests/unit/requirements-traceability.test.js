...
const { reconcileTraceability, validateG4Traceability, validateTraceabilityArtifact } = require("../../.claude/lib/requirements-traceability");
const { workspaceFingerprint } = require("../../.claude/lib/sensor-scope");
