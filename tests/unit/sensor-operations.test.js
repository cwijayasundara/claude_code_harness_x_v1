...
const { appendSensorHistory, assertEvidenceFresh, verifySensorHistory, watcherStatus } = require("../../.claude/lib/sensor-operations");
...
test("deliberate bad-code canary proves representative detections", () => {
  const project = root();
  const script = path.resolve(__dirname, "../../.claude/scripts/harness-sensor-canary.js");
