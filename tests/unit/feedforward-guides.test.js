...
const { REQUIRED_CAPABILITIES, loadGuideCatalog, resolveGuides, validateGuideCatalog } = require("../../.claude/lib/feedforward-guides");
const templateRoot = path.resolve(__dirname, "../../.claude/templates/project");
