...
const { checkCoverage, checkGenerative, checkMutation, checkTestIntegrity, mutationCounts } = require("../../.claude/lib/regression-sensors");

const regressionRunner = path.resolve(__dirname, "../../.claude/scripts/harness-regression.js");
